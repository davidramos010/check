            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 ">
                            <?= $form->field($model, 'id_comercial')->dropDownList(Registro::getComercialesDropdownList(), ['id' => 'id_comercial', 'class' => 'form-control', 'prompt' => 'Seleccione Uno', 'disabled' => true])->label(Yii::t('app', 'Empresa/Proveedor')); ?>
                        </div>
                        <div class="col-md-5 ">
